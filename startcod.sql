...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 17 Des 2023 pada 14.33
...
(5, '2023_12_17_132036_create_codes_table', 1);
...
(1, 'admin', 'admin satu', 'admin@gmail.com', '$2y$10$KKd.ljm91hxjhnUZrt0fU.6iPpa5gkt36Qvf86qhYCxHlZw5oSyk2', NULL, NULL);
...
--
-- Ketidakleluasaan untuk tabel `codes`
--
ALTER TABLE `codes`
